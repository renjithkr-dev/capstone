...
var DynamoDBProvider = /** @class */ (function () {
    function DynamoDBProvider() {
        var _this = this;
        this.addAppointment = function (appt) { return __awaiter(_this, void 0, void 0, function () {
            var params, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [2 /*return*/, Promise.resolve(appt)];
                    case 3:
                        e_1 = _a.sent();
        ...
        this.getUserAppointments = function (userId, apptDate) { return __awaiter(_this, void 0, void 0, function () {
            var params, appts, apptList, data_1, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        params = {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, Promise.resolve(data_1)];
                    case 3:
                        e_2 = _a.sent();
                        return [2 /*return*/, Promise.reject({ "error": e_2 })];
                    case 4: return [2 /*return*/];
                }
            });
        }); };
